const PolaroidBoxes = () => {
    ...
    <div className="flex justify-center gap-16 py-8 px-8 pb-24">
        ...
        <button className="font-Cairo absolute w-4/5 bottom-36 left-1/2 transform -translate-x-1/2 px-4 py-4 bg-white text-black bg-opacity-80 focus:outline-none"> SHOP OUTFITS </button>
        </div>
        ...
        <button className="font-Cairo absolute w-4/5 bottom-36 left-1/2 transform -translate-x-1/2 px-4 py-4 bg-white text-black bg-opacity-80 focus:outline-none" > LOVED POSTS & SUBSCRIBE </button>
        </div>
    </div>
    );
};
