const PolaroidBoxes = () => {
    ...
    <div className="flex justify-center gap-8 py-8 px-8">
        ...
        <div className="relative w-64 h-64 bg-white shadow-lg border-2 border-gray-200 rounded-lg overflow-hidden">
        <img
        ...
        />
        <button
            className="absolute w-4/5 bottom-24 left-1/2 transform -translate-x-1/2 px-4 py-2 bg-white text-black bg-opacity-60 focus:outline-none"
        >
            Button
        </button>
        </div>
        ...
        />
        <button
            className="absolute w-4/5 bottom-24 left-1/2 transform -translate-x-1/2 px-4 py-2 bg-white text-black bg-opacity-70 focus:outline-none"
        >
            Button
        </button>
        </div>
